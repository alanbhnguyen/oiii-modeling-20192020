...
# CHANGES
# 
# ADDED single_gaussian_lincont_curvefit to satisfy curve_fit to refit single gaussians
# =============================================================================
...
def double_gaussian_lincont_curvefit( x, amp1, vel1, vel_sigma1, amp2, vel2, vel_sigma2, slope, yint ):
    return gaussian(x, [amp1, vel1, vel_sigma1]) + gaussian(x,  [amp2, vel2, vel_sigma2]) + linear_continuum(x, [slope, yint])
...
def single_gaussian_lincont_curvefit( x, amp1, mu1, vel_sigma1, slope, yint ):
    return gaussian(x, [amp1, mu1, vel_sigma1]) + linear_continuum(x, [slope, yint])
